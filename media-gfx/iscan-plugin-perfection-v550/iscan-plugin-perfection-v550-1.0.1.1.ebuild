...
SRC_URI="
	x86? ( https://192.168.1.129/~paul/distfiles/${PN}-${MY_PVR}.i686.rpm )
	amd64? ( https://192.168.1.129/~paul/distfiles/${PN}-${MY_PVR}.x86_64.rpm )
"
...
QA_PREBUILT="/opt/iscan/lib/libesinteb.so*"
...
pkg_setup() {
	basecmds=(
		"iscan-registry --COMMAND interpreter usb 0x04b8 0x013b /opt/iscan/lib/libesinteb /usr/share/iscan/esfweb.bin"
	)
}
